...
import { netWorthPeople, formatNetWorth } from "../data/networth";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
    ...
    >
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Net Worth of Your Favorite Public Figures</h1>
            <p className="text-gray-600">
              Explore up-to-date net worth figures of top public figures in entertainment, sports, business, and more. Discover who's rising and their current value.
            </p>
          </div>
          <Link 
