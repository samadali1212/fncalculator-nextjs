  ...
  const renderApplicationSection = (job: Job) => {
    ...
    return (
      <div className="space-y-4">
        ...
        {type === 'letter' && (
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between bg-gray-50 p-4 rounded-md border gap-3">
            <div className="flex items-start min-w-0 flex-1">
              <Mail className="h-4 w-4 text-purple-600 mr-3 mt-0.5 flex-shrink-0" />
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-gray-900">Send your application letter to</p>
                <div className="text-sm text-gray-600 mt-1 whitespace-pre-line">{value}</div>
              </div>
            </div>
            <Button
              variant="outline"
    ...
    >
      <SEO
        ...
        jobPosting={{
          ...
          applicantLocationRequirements: "Tanzania",
