...
const CarLoan = () => {
  ...
  const handleTimeFrameChange = (value: string) => {
    if (value === "yearly" || value === "monthly") {
      navigate(`/car-loan${value !== "monthly" ? "/" + value : ""}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <h1 className="text-3xl font-bold mb-2">South Africa Car Loan Calculator</h1>
        <p className="text-gray-600 mb-8">
          Calculate your South African car loan payments with our comprehensive calculator.
          Get accurate {timeFrame === "monthly" ? "monthly" : "yearly"} payment estimates based on current interest rates, vehicle price, down payment, loan term, and balloon payment. Perfect for planning your car purchase in South Africa—featuring flexible parameters, instant results, and complete transparency for informed decision-making.
        </p>

        {/* Custom Car Loan Calculator */}
        <CarLoanCalculator 
          timeFrame={timeFrame}
            ...
            >
              <div className="grid grid-cols-12 items-center">
                <div className="col-span-4 md:col-span-3">
                  <Link 
                    to={`/car-loan/${timeFrame}/${result.vehiclePrice}/${result.downPayment}/${result.loanTerm}/${result.interestRate}/${result.balloonPayment}`}
