...
import { getAllCategories, Category } from "../utils/expensiveThingsData";
...
const GlobalStandaloneCategories = () => {
  ...
  return (
    ...
    >
      <SEO 
        title="Most Expensive Things Categories" 
        description="Explore the world's most expensive items by categories - from real estate to vehicles and art pieces."
        canonicalUrl="/price-categories"
      />
      <Header />
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Rankings of The Most Expensive Things</h1>
            <p className="text-gray-600">
              Explore the world's most expensive items organized by different categories
            </p>
          </div>
