...
import { getAllCelebrityMetadata, CategoryMetadata } from "../utils/celebrityCategoriesData";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
...
const StandaloneCelebrityCategories = () => {
                  ...
                  <div className="grid grid-cols-12 items-center">
                    ...
                    <div className="col-span-6 md:col-span-5">
                      <div className="flex items-center">
                        ...
                        <div>
                          <Link 
                            to={`/celebrities/category/${category.slug}`}
...
export default StandaloneCelebrityCategories;
