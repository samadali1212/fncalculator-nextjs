      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <div className="bg-white p-6 rounded-sm shadow-sm">
          ...
          <div className="prose max-w-none">
            <p className="mb-4">
Financepedia is your go-to platform for financial insights tailored to South Africans. We provide expert advice, practical tools, and the latest updates on personal finance, investments, and economic trends.
            </p>
            <p className="mb-4">
