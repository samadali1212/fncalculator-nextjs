  ...
  return (
    ...
    >
      <SEO 
        ...
        description="Learn about Financepedia - your trusted source for financial information in South Africa. Discover our mission to help South Africans make informed financial decisions."
        canonicalUrl="/about"
      />
      <Header />
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <div className="bg-white p-6 rounded-sm shadow-sm">
         <h1 className="text-2xl font-bold mb-4">About Financepedia</h1>
          <div className="prose max-w-none">
            <p className="mb-4">
              Financepedia is your trusted source for financial information in South Africa. We provide up-to-date data on banking, branch codes, net worth insights, and other financial information to help South Africans make informed decisions about their money.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Stay informed and take control of your financial journey with Financepedia.
            </p>
