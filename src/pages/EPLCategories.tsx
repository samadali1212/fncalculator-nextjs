...
import { getAllEPLCategoriesMetadata, CategoryMetadata } from "../utils/eplCategoriesData";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
...
const EPLCategories = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setCategories(getAllEPLCategoriesMetadata());
      setIsLoading(false);
    }, 300);
  ...
  return (
    ...
    >
      <SEO 
        title="Premier League Salary Categories - SalaryList" 
        description="Browse English Premier League salary categories by team, position, and nationality. Find out which clubs pay the highest wages and who are the top earners."
        canonicalUrl="/epl-categories"
      />
      <Header />
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">EPL Salary Categories</h1>
            <p className="text-gray-600">
              The English Premier League features some of the highest-paid athletes in world football. 
              These categories break down player salaries by team, position, and more to help you explore the financial landscape of the EPL.
            </p>
          </div>
                  ...
                  <div className="grid grid-cols-12 items-center">
                    ...
                    <div className="col-span-6 md:col-span-5">
                      <div className="flex items-center">
                        ...
                        <div>
                          <Link 
                            to={`/epl-players/category/${category.slug}`}
