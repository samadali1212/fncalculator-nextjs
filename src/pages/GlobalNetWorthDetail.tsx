        ...
        <div className="bg-white p-6 md:p-8 rounded-sm shadow-sm border border-gray-200">
          ...
          <div className="mt-8">
            ...
            <div className="prose max-w-none">
              ...
              <SEOParagraph
                title={`${person.name}'s Net Worth Growth`}
                text={`${person.name}'s current net worth is estimated at ${formatNetWorth(person.netWorth, person.currency || 'USD')}. Their wealth has been accumulated through ${person.industry ? `their ventures in the ${person.industry} industry` : 'various business activities'}.`}
              />
            </div>
          </div>
        </div>
