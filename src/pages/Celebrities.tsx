    ...
    >
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Higest Paid People in South Africa And Their Salaries Per Month</h1>
            <p className="text-gray-600">
              List of the highest-earning South Africans with their salary per month. From entertainers and athletes to business leaders and influencers, see how much the country's top figures make and what contributes to their wealth.
            </p>
          </div>
        </div>
