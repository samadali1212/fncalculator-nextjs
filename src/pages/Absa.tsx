...
const Absa = () => {
  ...
  const handleTimeFrameChange = (value: string) => {
    if (value === "yearly" || value === "monthly") {
      navigate(`/absa${value !== "monthly" ? "/" + value : ""}`);
    }
  };
  ...
  return (
    ...
    >
      <SEO 
        title="ABSA Bank Personal Loan Calculator 2024/2025 - Calculate Monthly Payments" 
        description="Calculate your ABSA Bank personal loan payments with our 2024/2025 calculator. Monthly and annual payment calculations at 16% interest rate with customizable terms."
        canonicalUrl={`/absa${timeFrame !== "monthly" ? "/" + timeFrame : ""}`}
      />
      <Header />
      
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <h1 className="text-3xl font-bold mb-2">ABSA Bank Personal Loan Calculator 2024/2025</h1>
        ...
        <p className="text-gray-600 mb-8">
          <em><strong>Interest rates may vary based on your credit profile and loan terms. Contact ABSA Bank for personalized rates.</strong></em>
        </p>
            ...
            >
              <div className="grid grid-cols-12 items-center">
                <div className="col-span-4 md:col-span-3">
                  <Link 
                    to={`/absa/${timeFrame}/${result.loanAmount}/${result.interestRate}/${result.loanTerm}`}
