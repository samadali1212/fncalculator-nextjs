...
const Capitec = () => {
  ...
  const loanResults = generateHomeLoanCalculations(
    200000,   // Min: R200,000 (Capitec typically has lower minimums)
    3000000,  // Max: R3,000,000 
    50000,    // Step: R50,000
    9.75,     // Capitec competitive home loan rate
    25,       // 25 years (Capitec standard term)
    0,        // Down payment
    timeFrame
  );
  ...
  const handleTimeFrameChange = (value: string) => {
    if (value === "yearly" || value === "monthly") {
      navigate(`/capitec${value !== "monthly" ? "/" + value : ""}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <h1 className="text-3xl font-bold mb-2">Capitec Bank Home Loan Calculator South Africa</h1>
        <p className="text-gray-600 mb-8">
          Calculate your Capitec Bank home loan payments with our comprehensive calculator.
          Get accurate {timeFrame === "monthly" ? "monthly" : "yearly"} payment estimates based on Capitec's competitive interest rates, loan amount, down payment, and loan term. Perfect for planning your home purchase with Capitec Bank South Africa—featuring flexible parameters, instant results, and complete transparency for informed decision-making.
        </p>
        ...
        <p className="text-gray-600 mb-8">
          <em>Capitec Bank interest rates may vary based on your credit profile, loan terms, and market conditions. Contact Capitec Bank for personalized rates and pre-approval.</em>
        </p>
            ...
            >
              <div className="grid grid-cols-12 items-center">
                <div className="col-span-4 md:col-span-3">
                  <Link 
                    to={`/capitec/${timeFrame}/${result.loanAmount}/${result.downPayment}/${result.loanTerm}/${result.interestRate}`}
