...
const Azania = () => {
  ...
  return (
    ...
    >
      <SEO 
        title="Azania Bank Personal Loan Calculator 2024/2025 - Calculate Monthly Payments" 
        description="Calculate your Azania Bank personal loan payments with our 2024/2025 calculator. Monthly and annual payment calculations at 17% interest rate with customizable terms."
        canonicalUrl={`/azania${timeFrame !== "monthly" ? "/" + timeFrame : ""}`}
      />
      <Header />
      
      <main className="container mx-auto pt-24 px-4 md:px-6 pb-16 max-w-4xl">
        <h1 className="text-3xl font-bold mb-2">Azania Bank Personal Loan Calculator 2024/2025</h1>
