...
const USCongressDetail = () => {
  ...
  const getSalaryParagraph = () => {
    ...
    return `${member.name}, a ${member.party} ${member.position} from ${member.state}, earns an annual salary of ${annualSalary} and has an estimated net worth of $${netWorth}. Annually, this salary of ${annualSalary} equals ${monthlySalary} per month.`;
  };
