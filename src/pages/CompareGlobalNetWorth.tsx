...
const CompareGlobalNetWorth = () => {
  ...
  const navigateToSEOUrl = (p1: string, p2: string) => {
    const url = `/compare-global/${p1}-vs-${p2}`;
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              <Button 
                ...
                className="inline-flex items-center justify-center text-sm text-[#000000] hover:bg-white/60"
              >
                <ChevronLeft className="h-4 w-4 mr-1" />
                Back to Global Net Worth Comparisons
              </Button>
            </div>
            
            <ShareButton 
              title={person1 && person2 ? `${person1.name} vs ${person2.name} - Who is richer?` : "Global Wealth Comparison"} 
              variant="outline"
            />
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-md shadow-sm mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-center mb-2">
              {person1 && person2 ? `${person1.name} vs ${person2.name} - Who is Richer?` : "Global Wealth Comparison"}
            </h1>
...
export default CompareGlobalNetWorth;
