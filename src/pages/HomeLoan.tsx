...
const HomeLoan = () => {
  ...
  return (
    ...
    >
      <SEO 
        title="South Africa Home Loan Calculator - Monthly & Annual Payments" 
        description="Calculate your South African home loan payments with our comprehensive calculator. Get accurate monthly and annual payment estimates with customizable loan terms, down payments, and interest rates."
        canonicalUrl={`/home-loan${timeFrame !== "monthly" ? "/" + timeFrame : ""}`}
      />
      <Header />
            ...
            >
              <div className="grid grid-cols-12 items-center">
                <div className="col-span-4 md:col-span-3">
                  <Link 
                    to={`/home-loan/${timeFrame}/${result.loanAmount}/${result.downPayment}/${result.loanTerm}/${result.interestRate}`}
