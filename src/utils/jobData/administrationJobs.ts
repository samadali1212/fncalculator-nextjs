...
export const administrationJobs: Job[] = [
{
  ...
  company: "Exim Bank",
  location: "Dar es Salaam, Tanzania", // Inferred based on previous Exim Bank job
  ...
  location: "Arusha, Tanzania (with occasional travel)",
  category: "Accounting",
  salaryRange: "Not Disclosed",
  ...
  company: "Equity Bank",
  location: "Dar es Salaam, Tanzania", // Inferred as a common location for a bank's HQ
  ...
  postedDate: "2025-06-01", // Inferred from 'June 2025'
  deadline: "2025-06-13",
  featured: false
}
