...
// Data for coins marketplaces
const coinsMarketPlacesData: GeneralKnowledgeItem[] = [

{
  id: "city-coins-marketplace",
  title: "City Coins",
  slug: "city-coins-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Established dealer based in Cape Town offering expert numismatic services.",
  fullDescription: "City Coins has been active in the South African coin scene for decades. Based in Cape Town, this specialist platform is known for rare and valuable coins, with a focus on ZAR and Union issues. Collectors can browse current stock, get valuations, or submit coins for sale through their site. The team offers grading advice and auction support, making it a trusted resource for serious buyers and sellers. Their reputation is built on experience and integrity, making it one of the go-to places in the country.",
  imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiz9xKhZmXPxjW36421xW1B-ejPfpvX9SHmw&s",
  facts: [
    { title: "Location", value: "Cape Town" },
    { title: "Type", value: "Dealer Website" },
    { title: "Focus", value: "ZAR and Union Coins" },
    { title: "Valuations", value: "Yes, free consultations" },
    { title: "Sales Method", value: "Direct & Consignment" },
    { title: "Website", value: "citycoins.com" }
  ],
  tags: ["city coins", "cape town", "zar", "dealer", "numismatic"],
  rating: 4.7,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "sa-coin-marketplace",
  title: "SA Coin",
  slug: "sa-coin-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Johannesburg-based coin dealer with a large online presence and inventory.",
  fullDescription: "SA Coin is a Johannesburg-based company known for buying and selling South African coins, especially the Krugerrand and ZAR coins. Their website features a regularly updated inventory and a valuation tool. Customers can sell coins directly, request a quote, or browse educational material about coin collecting. Their platform is well-suited for both novice and experienced collectors seeking expert advice and market value. SA Coin is also one of the largest and most recognizable numismatic businesses in South Africa, offering reliable service and guidance.",
  imageUrl: "https://www.samint.co.za/wp-content/uploads/2017-ORTambo-R5-CC_obv.png",
  facts: [
    { title: "Location", value: "Johannesburg" },
    { title: "Type", value: "Dealer Website" },
    { title: "Focus", value: "Krugerrand & ZAR" },
    { title: "Valuations", value: "Online form" },
    { title: "Sales Method", value: "Direct" },
    { title: "Website", value: "sacoin.co.za" }
  ],
  tags: ["sa coin", "krugerrand", "dealer", "johannesburg", "zar"],
  rating: 4.6,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "bob-shop-coin-marketplace",
  title: "Bob Shop (Bidorbuy)",
  slug: "bob-shop-coin-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Popular South African auction site for collectibles including coins.",
  fullDescription: "Bob Shop, formerly known as Bidorbuy, is one of South Africa’s largest online marketplaces. Coin sellers list items for auction or fixed price, reaching thousands of local buyers. It supports secure payments and provides detailed seller feedback, helping to build trust. Ideal for casual or bulk sales, it suits collectors who want exposure without setting up their own store. Users can also browse historic listings to estimate coin values. The user-friendly interface and large customer base make it a smart platform for coin traders.",
  imageUrl: "https://upload.wikimedia.org/wikipedia/commons/c/cf/Bob_Shop_Logo.png",
  facts: [
    { title: "Location", value: "South Africa (Online)" },
    { title: "Type", value: "Auction & Buy Now" },
    { title: "Focus", value: "General & Collectibles" },
    { title: "Valuations", value: "No" },
    { title: "Sales Method", value: "Self-listing" },
    { title: "Website", value: "bobshop.co.za" }
  ],
  tags: ["bob shop", "bidorbuy", "auction", "online", "collectibles"],
  rating: 4.5,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "ebay-south-africa-marketplace",
  title: "eBay South Africa",
  slug: "ebay-south-africa-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Global auction platform with a large coin-buying audience.",
  fullDescription: "eBay’s global reach makes it a solid option for selling South African coins to international collectors. The platform supports secure payment processing and shipping integration. Sellers gain access to coin enthusiasts from the US, UK, and Europe, expanding beyond local interest. Listing tools, market insights, and seller protections help users list and manage inventory confidently. Though fees apply, the visibility and audience size often justify the cost. It's particularly useful for rare coins and collector-grade items that might fetch higher bids abroad.",
  imageUrl: "https://cdn-icons-png.flaticon.com/512/217/217436.png",
  facts: [
    { title: "Location", value: "International" },
    { title: "Type", value: "Auction & Buy Now" },
    { title: "Focus", value: "Global Collectibles" },
    { title: "Valuations", value: "No" },
    { title: "Sales Method", value: "Self-listing" },
    { title: "Website", value: "ebay.com" }
  ],
  tags: ["ebay", "international", "auction", "coins", "collectors"],
  rating: 4.4,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "gumtree-coin-marketplace",
  title: "Gumtree South Africa",
  slug: "gumtree-coin-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Local classifieds site with a wide range of coin listings.",
  fullDescription: "Gumtree is a South African classifieds platform where individuals can list old coins for free. It’s ideal for reaching nearby buyers without middlemen. Sellers create simple listings with photos, prices, and descriptions. Communication happens directly through chat or phone. While it lacks advanced features like escrow or valuation tools, it works well for fast and informal sales. Caution is advised with higher-value items due to potential scams, but for everyday trades and basic listings, it's one of the most accessible platforms in the country.",
  imageUrl: "https://standfirst-designweek-production.imgix.net/uploads/2016/01/06171209/GUM_Koto_02.jpg?fit=crop&crop=faces&q=80&auto=compress,format&w=364&h=404&dpr=2.625",
  facts: [
    { title: "Location", value: "South Africa (Local)" },
    { title: "Type", value: "Classifieds" },
    { title: "Focus", value: "General Goods" },
    { title: "Valuations", value: "No" },
    { title: "Sales Method", value: "Direct" },
    { title: "Website", value: "gumtree.co.za" }
  ],
  tags: ["gumtree", "classifieds", "local", "coins", "direct sale"],
  rating: 4.2,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "junk-mail-coin-marketplace",
  title: "Junk Mail",
  slug: "junk-mail-coin-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Popular South African classifieds site for secondhand items and coins.",
  fullDescription: "Junk Mail serves as a long-standing online classifieds platform in South Africa, letting users post free ads for coins and other collectibles. Its wide reach across cities like Pretoria, Durban, and Cape Town helps connect sellers with local buyers quickly. There are no listing fees, and sellers handle all transactions directly. The platform’s simplicity makes it useful for casual sales. It’s best to include clear pictures and detailed descriptions to improve interest and avoid unnecessary back-and-forth with potential buyers.",
  imageUrl: "https://img.utdstc.com/icon/e2c/c09/e2cc09a8ad69058dc7bde2a3a6700ea09e0328d0b6553562768e4a9f253dba40:200",
  facts: [
    { title: "Location", value: "South Africa (Nationwide)" },
    { title: "Type", value: "Classifieds" },
    { title: "Focus", value: "Secondhand Goods" },
    { title: "Valuations", value: "No" },
    { title: "Sales Method", value: "Direct" },
    { title: "Website", value: "junkmail.co.za" }
  ],
  tags: ["junk mail", "classifieds", "local", "free ads", "coins"],
  rating: 4.1,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "cash-crusaders-coin-marketplace",
  title: "Cash Crusaders Online",
  slug: "cash-crusaders-coin-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Franchise retailer with online listings for secondhand coins.",
  fullDescription: "Cash Crusaders is a major secondhand retail chain across South Africa. Through their online store, sellers can get quotes or visit a nearby branch to sell coins. They typically accept circulated or common coins at reasonable rates. Listings from individual stores sometimes include collectible coins, which gives buyers an idea of resale potential. It’s a reliable place for quick sales but not ideal for rare pieces. Their physical presence helps ensure smoother transactions and in-person assessments for interested sellers.",
  imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThXPZgBCbYVCedBJ-pNdTOihRnQa4g0wB2Wg&s",
  facts: [
    { title: "Location", value: "South Africa (Branches + Online)" },
    { title: "Type", value: "Retail Franchise" },
    { title: "Focus", value: "Secondhand Goods" },
    { title: "Valuations", value: "In-person or online quote" },
    { title: "Sales Method", value: "Direct" },
    { title: "Website", value: "cashcrusaders.co.za" }
  ],
  tags: ["cash crusaders", "retail", "online", "branches", "coins"],
  rating: 4.0,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "cash-converters-coin-marketplace",
  title: "Cash Converters Webshop",
  slug: "cash-converters-coin-marketplace",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Trusted franchise for buying and selling coins through stores or online.",
  fullDescription: "Cash Converters offers a convenient way to sell coins either in-store or through their website. The chain has built a name around safe, fast transactions with set standards. Coins listed through their webshop are inspected and graded by staff, and often resold to collectors browsing the platform. While the offers may not always reflect collector pricing, it’s a great option for those looking to move coins without much effort. Transactions are processed in a structured and reliable environment.",
  imageUrl: "https://upload.wikimedia.org/wikipedia/commons/d/d2/CashConvertersLogo.svg",
  facts: [
    { title: "Location", value: "South Africa (Nationwide)" },
    { title: "Type", value: "Retail Franchise" },
    { title: "Focus", value: "Secondhand & Collectibles" },
    { title: "Valuations", value: "Store-based" },
    { title: "Sales Method", value: "Direct or Consignment" },
    { title: "Website", value: "cashconverters.co.za" }
  ],
  tags: ["cash converters", "webshop", "coins", "branches", "sell fast"],
  rating: 4.1,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "sa-numismatic-society",
  title: "SA Numismatic Society",
  slug: "sa-numismatic-society",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Educational and trading hub for serious collectors and sellers.",
  fullDescription: "The South African Numismatic Society connects coin collectors and dealers through monthly meetings, newsletters, and private auctions. Members can trade, get valuations, and list items for sale in trusted networks. Though not a direct marketplace, it's a strong choice for those wanting serious exposure and access to expert advice. Events often feature rare finds and historical pieces, making it a valuable source of insights and opportunities. For sellers with high-value coins, this community adds credibility and collector-level interest.",
  imageUrl: "https://sapc.org.au/wp-content/uploads/2022/04/Numismatic-Society-Scaled.png",
  facts: [
    { title: "Location", value: "South Africa (Membership-based)" },
    { title: "Type", value: "Collector Network" },
    { title: "Focus", value: "Numismatics" },
    { title: "Valuations", value: "Yes, member access" },
    { title: "Sales Method", value: "Private Auctions" },
    { title: "Website", value: "sansa.org.za" }
  ],
  tags: ["numismatic society", "collectors", "auctions", "rare coins", "network"],
  rating: 4.3,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "heritage-auctions-south-africa",
  title: "Heritage Auctions",
  slug: "heritage-auctions-south-africa",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "International auction house with access to premium buyers.",
  fullDescription: "Heritage Auctions is a US-based auction platform that accepts consignments from South Africa. It’s especially beneficial for sellers with rare or high-grade coins that could attract international buyers. Their team assists with appraisals, marketing, and shipping logistics. Listings often gain significant attention, and final sale prices tend to be strong. Although the process includes fees and approvals, the global exposure can dramatically improve the chances of a high return. It’s suited to experienced sellers or those working with trusted agents.",
  imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReyrWVXDt1QmpT2S1Zhd0zwPu-OsfjLU-9WA&s",
  facts: [
    { title: "Location", value: "International (US-based)" },
    { title: "Type", value: "Premium Auction House" },
    { title: "Focus", value: "High-end Collectibles" },
    { title: "Valuations", value: "Yes, pre-sale" },
    { title: "Sales Method", value: "Consignment" },
    { title: "Website", value: "ha.com" }
  ],
  tags: ["heritage auctions", "premium", "international", "rare coins", "valuation"],
  rating: 4.8,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "numismatics-coza",
  title: "Numismatics.co.za",
  slug: "numismatics-coza",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Dedicated coin site offering expert listings and evaluations.",
  fullDescription: "Numismatics.co.za focuses on the South African collector market, showcasing a variety of rare and commemorative coins for sale. Users can browse verified listings or contact them directly to sell coins. The platform also publishes educational content and provides basic guidance on coin values. It serves as a more specialised alternative to general marketplaces. Their site supports both hobbyists and experienced collectors. Sellers looking to reach a focused audience of coin enthusiasts benefit from the site's niche credibility and clear layout.",
  imageUrl: "https://i.ebayimg.com/images/g/USgAAOSwi01iwvkp/s-l1200.jpg",
  facts: [
    { title: "Location", value: "South Africa" },
    { title: "Type", value: "Specialist Coin Store" },
    { title: "Focus", value: "Rare and Commemorative Coins" },
    { title: "Valuations", value: "Yes, on request" },
    { title: "Sales Method", value: "Direct Sale or Consignment" },
    { title: "Website", value: "numismatics.co.za" }
  ],
  tags: ["numismatics", "rare coins", "collectors", "coin sales", "south africa"],
  rating: 4.4,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  ...
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "South African coin dealer buying and selling collectible coins.",
  fullDescription: "Coin World operates a digital storefront for buying and selling collectible coins, including Krugerrands, commemorative pieces, and world currency. They’re known for competitive pricing and clear grading standards. Users can reach out through their site to request a valuation or arrange a sale. They also deal in silver and gold bullion. This platform is ideal for sellers with high-demand pieces who prefer working with established dealers. Many of their listings cater to serious collectors and investors in precious metals.",
  imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjZMntWFbgV-4qUr9r6OnmnTAf-c3I9SAuvA&s",
  facts: [
    { title: "Location", value: "South Africa (Cape Town-based)" },
    { title: "Type", value: "Coin Dealer" },
    { title: "Focus", value: "Collectible and Bullion Coins" },
    { title: "Valuations", value: "Yes" },
    { title: "Sales Method", value: "Direct" },
    { title: "Website", value: "coinworld.co.za" }
  ],
  tags: ["coin world", "krugerrand", "bullion", "dealers", "valuations"],
  rating: 4.5,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "rarecoins-coza",
  title: "Rare Coins South Africa",
  slug: "rarecoins-coza",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Dealer and marketplace for investing in rare South African coins.",
  fullDescription: "RareCoins.co.za is a niche platform offering investment-grade coins and historical pieces. Their team includes numismatic experts who evaluate submissions and provide quotes based on market trends. They regularly feature coins with limited mintage or exceptional condition, making it ideal for serious sellers. Although prices are set based on strict criteria, the visibility and buyer pool are both strong. Sellers are guided through the listing process and can expect informed buyers familiar with the South African coin market and investment value.",
  imageUrl: "https://i.ebayimg.com/images/g/ZCUAAOSwiXNdmexq/s-l1200.jpg",
  facts: [
    { title: "Location", value: "South Africa" },
    { title: "Type", value: "Investment Coin Dealer" },
    { title: "Focus", value: "Rare and Historical Coins" },
    { title: "Valuations", value: "Yes, expert-based" },
    { title: "Sales Method", value: "Direct or Consignment" },
    { title: "Website", value: "rarecoins.co.za" }
  ],
  tags: ["rare coins", "investment", "collectibles", "historical", "dealers"],
  rating: 4.6,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
},
{
  id: "looting-coins-facebook-group",
  title: "Looting Coins SA (Facebook Group)",
  slug: "looting-coins-facebook-group",
  categoryId: "coin-marketplaces",
  categoryName: "Coin Marketplaces in South Africa",
  shortDescription: "Lively Facebook community where users buy and sell South African coins.",
  fullDescription: "Looting Coins SA is a Facebook group with thousands of members discussing, buying, and trading South African coins. Group rules are strict to prevent scams and maintain credibility. Sellers post photos, prices, and details directly. Admins often verify listings and moderate deals. This space is useful for active collectors and informal sales, offering great visibility through Facebook’s built-in audience. It’s important to interact respectfully and follow post guidelines for best results. Posts with rare coins often get quick responses and offers.",
  imageUrl: "https://www.muntstuk.com/4964-large_default/r5-south-africa-2018-bimetallic-nelson-mandela-centenary.jpg",
  facts: [
    { title: "Location", value: "Facebook (South Africa-focused)" },
    { title: "Type", value: "Community Group" },
    { title: "Focus", value: "Coin Trading & Discussion" },
    { title: "Valuations", value: "Peer-based" },
    { title: "Sales Method", value: "Direct in comments or DMs" },
    { title: "Website", value: "facebook.com/groups/lootingcoinsSA" }
  ],
  tags: ["facebook", "looting coins", "group", "coin sales", "community"],
  rating: 4.2,
  createdAt: "2023-05-10",
  updatedAt: "2025-04-12",
}
