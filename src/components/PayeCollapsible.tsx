    ...
    >
      ...
      <div className="space-y-4">
        ...
        <Collapsible defaultOpen>
          ...
          <CollapsibleContent className="mt-2 p-6 bg-white rounded-lg border">
            <div className="space-y-4">
              <p className="text-sm text-gray-700">Tanzania uses a progressive tax system with the following monthly brackets for Tanzania Mainland:</p>
              <div className="space-y-2">
                <div className="flex justify-between p-2 bg-gray-50 rounded">
                  <span className="text-sm">TSh 0 - 270,000</span>
                  <span className="font-medium text-sm">0% (NIL)</span>
                </div>
                <div className="flex justify-between p-2 bg-gray-50 rounded">
                  <span className="text-sm">TSh 270,001 - 520,000</span>
                  <span className="font-medium text-sm">8% of excess above TSh 270,000</span>
                </div>
                <div className="flex justify-between p-2 bg-gray-50 rounded">
                  <span className="text-sm">TSh 520,001 - 760,000</span>
                  <span className="font-medium text-sm">TSh 20,000 + 20% of excess above TSh 520,000</span>
                </div>
                <div className="flex justify-between p-2 bg-gray-50 rounded">
                  <span className="text-sm">TSh 760,001 - 1,000,000</span>
                  <span className="font-medium text-sm">TSh 68,000 + 25% of excess above TSh 760,000</span>
                </div>
                <div className="flex justify-between p-2 bg-gray-50 rounded">
                  <span className="text-sm">Above TSh 1,000,000</span>
                  <span className="font-medium text-sm">TSh 128,000 + 30% of excess above TSh 1,000,000</span>
                </div>
              </div>
        ...
        <Collapsible defaultOpen>
          ...
          <CollapsibleContent className="mt-2 p-6 bg-white rounded-lg border">
            <div className="space-y-6">
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Provisional Returns (Form ITX200.01.E)</h4>
                <p className="text-sm text-gray-700 mb-2">Estimated tax must be filed within 3 months of the year beginning, with payments in 4 installments:</p>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Final Returns (Form ITX201.01.E)</h4>
                <p className="text-sm text-gray-700 mb-2">Must be filed within 6 months after the tax year ends (between 1st January and 30th June).</p>
        ...
        <Collapsible defaultOpen>
          ...
          <CollapsibleContent className="mt-2 p-6 bg-white rounded-lg border">
            <div className="space-y-6">
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Return Form Components</h4>
                <p className="text-sm text-gray-700 mb-3">The return form consists of seven pages plus supplementary pages for:</p>
