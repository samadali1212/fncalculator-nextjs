...
import { formatCurrency, HomeLoanTimeFrame } from "../utils/homeLoanCalculator";
...
interface HomeLoanAmortizationScheduleProps {
  homePrice: number;
  downPayment: number;
  interestRate: number;
  loanTerm: number;
...
const HomeLoanAmortizationSchedule = ({ homePrice, downPayment, interestRate, loanTerm, timeFrame }: HomeLoanAmortizationScheduleProps) => {
  ...
  return (
    <div className="mb-8">
      ...
      <p className="text-sm text-gray-600 mb-4">
        This table shows how your {timeFrame === "monthly" ? "monthly" : "annual"} payments are split between principal and interest over the life of your home loan.
      </p>
...
export default HomeLoanAmortizationSchedule;
