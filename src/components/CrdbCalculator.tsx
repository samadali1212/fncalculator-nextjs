...
const CrdbCalculator = ({ timeFrame, onTimeFrameChange, initialAmount, initialRate, initialTerm }: CrdbCalculatorProps) => {
  ...
  const viewDetailedCalculation = () => {
    if (loanResult) {
      navigate(`/crdb/${timeFrame}/${loanResult.loanAmount}/${numericInterestRate}/${numericLoanTerm}`);
    }
  };
        ...
        <>
          ...
          <div className="text-sm text-gray-600 leading-relaxed">
            <p>
              ...
              Click below to see the complete breakdown including total interest and repayment schedule.
            </p>
          </div>
