      ...
      {customTaxResult && (
        <>
          ...
          <div className="mb-6 text-sm text-gray-700 leading-relaxed">
            ...
            <p className="mb-2">
              <strong>Effective Tax Rate:</strong> {customTaxResult.effectiveTaxRate.toFixed(1)}% of your total income goes to PAYE tax
            </p>
            <p>
              <strong>Marginal Tax Rate:</strong> For each additional Tanzanian Shilling earned, you'll pay {customTaxResult.marginalTaxRate}% in PAYE tax
            </p>
          </div>
        </>
      )}
