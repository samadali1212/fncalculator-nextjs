...
interface CarLoanDetailCalculatorProps {
  ...
  onLoanChange: (vehiclePrice: number, downPayment: number, interestRate: number, loanTerm: number, balloonPayment: number) => void;
}

const CarLoanDetailCalculator = ({ 
  timeFrame, 
  onTimeFrameChange, 
  initialVehiclePrice,
  initialDownPayment, 
  ...
  const [balloonPayment, setBalloonPayment] = useState(initialBalloonPayment);
  ...
  useEffect(() => {
    onLoanChange(numericVehiclePrice, numericDownPayment, numericInterestRate, numericLoanTerm, numericBalloonPayment);
  }, [vehiclePrice, downPayment, interestRate, loanTerm, balloonPayment, onLoanChange]);
...
export default CarLoanDetailCalculator;
